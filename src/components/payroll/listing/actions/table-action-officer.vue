  ...
  <div class="actions" >
    <Transition name="slide-fade" >
      ...
      <div class="panel" >
        ...
        <n-tooltip trigger="hover">
          <template #trigger>
            <svg class="action text-blue-600" @click="generateSalary" 
    ...
    <!-- Form update account -->
    <detail-form v-bind:model="model" v-bind:record="record" v-bind:salaryDate='salaryDate' v-bind:salaryType='salaryType' v-bind:show="detailModal.show" :onClose="closeDetail"/>
    <!-- Form Profile -->
...
import DetailForm from '../../widgets/salary_preview.vue'
...
export default {
  ...
  setup(props){
    ...
    function generateSalary(){
      console.log( dateFormat( new Date( props.salaryDate ) , 'dd-mm-yyyy' ) )
...
.vcb-thumbnail .actions .panel {
  @apply w-full top-0 bottom-0 flex flex-wrap justify-center rounded-l;
}
.vcb-thumbnail .actions .action {
  @apply cursor-pointer w-6 mr-1 p-1 bg-white border border-gray-200 rounded ;
}
</style>