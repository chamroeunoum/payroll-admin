            ...
            <div class=" mx-auto p-4 flex-wrap">
              <div class="crud-form-panel w-full flex flex-wrap ">
                ...
                >
                  ...
                  <div class="w-full mt-2 mb-4 py-1 border-b border-gray-200 " >ព័ត៌មានក្នុងក្រុមហ៊ុន</div>
                  <n-form-item label="ប្រាក់ខែ" path="code" class="w-6/12 p-1" >
                    <n-input type="number"
                      v-model:value="record.salary" placeholder="ប្រាក់ខែ" 
                      :min="0"
                      class="w-full"
                      >
                  ...
                  <n-form-item label="អ៊ីមែល" path="officer_email" class="w-1/2 p-1" >
                  ...
                  <n-form-item label="ផ្នែក" path="officer_organization" class="w-1/2 mb-4 p-1" >
                    <n-select
                  ...
                  <n-form-item label="តួនាទី" path="officer_position" class="w-1/2 mb-4 p-1" >
                    <n-select
  ...
  setup(props){
     ...
     */
     function clearRecord( actionStatus ){
      ...
      props.record.people.gender = ''
      props.record.people.marry_status = ''
      props.record.people.mobile_phone = ''
      props.record.people.email = ''
      props.record.people.nid = ''
      props.record.people.address = ''
      props.record.people.pob = ''
      props.record.salary = ''
      props.record.position_id = null
      props.record.organization_id = null
      ...
      store.dispatch( props.model.name+'/createNonOfficer',
        {
          ...
          'salary' : parseFloat( props.record.salary ) <= 0 ? 0 : parseFloat( props.record.salary ) ,
          // People
