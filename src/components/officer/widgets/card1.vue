<template>
  <!-- Form edit account -->
    <div class="vcb-pop-create font-ktr ">
      ...
      class=" bg-white p-8 " >
        <!-- Form edit account -->
        <div class="card relative border border-gray-300 rounded mx-auto bg-center bg-cover bg-no-repeat overflow-hidden" style="background-image: url('/src/assets/logo.jpg'); background-size: 70% 70%;" >
