            ...
            <div class=" mx-auto p-4 flex-wrap">
              <div class="crud-form-panel w-full flex flex-wrap ">
                ...
                >
                  ...
                  <n-form-item label="ឈ្មោះខ្មែរ" class="w-full p-1" >
                    <n-input v-model:value="record.name_kh" placeholder="ឈ្មោះខ្មែរ" />
                  </n-form-item>
                  <n-form-item label="បរិយាយ" class="w-full p-1" >
                    <n-input type="textarea" v-model:value="record.desp" placeholder="បរិយាយ" />
                  </n-form-item>
                </n-form>
