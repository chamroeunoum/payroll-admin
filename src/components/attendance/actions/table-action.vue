<template>
  <div class="actions" >
    ...
    <div class="static-notification" >
      <n-tooltip v-if="!show && record.invoices != undefined && record.invoices.find( i => i.bill_date == null || i.bill_date == '' )" trigger="hover">
        <template #trigger>
        ...
        មានវិក័យបត្រជំពាក់ {{ $toKhmer( record.invoices.map( i => i.bill_date == null && i.bill_date == '' ).length ) }}
      </n-tooltip>
